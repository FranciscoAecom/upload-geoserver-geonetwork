param(
  [string]$Folder = "L:\Secure_DCS\BRBLH1PINFW001\COE_Digital\coe_digital_data\silver_data\restricted\pcd\ur_car_pe\AECOM\20260514\00",
  ...
  [string]$Store = "pol_pcd_ur_car_pe_20260514",
  [string]$Layer = "pol_pcd_ur_car_pe_20260514",
  [string]$LayerTitle,
  [string]$Style,
